            ...
            >
              {recentcars.map((items, index) => (
                <SwiperSlide key={index} className="">
                  <div className="cardMain explorCollectionCard">
                    <div className="card border-0 position-relative">
                      <Link href="" className="position-relative">
                        <img
                          ...
                          height={218}
                        />
                         <div className="carosaBisk exploreBisk">
                            <p className="text-white m-0 py-1 px-4 fSize-2 fw-normal text-center">{items.platform}</p>
                        </div>
                      </Link>
                      ...
                      <div className="card-body">
                        ...
                        <div className="pricingDetailes d-flex align-items-center justify-content-between mt-3">
                          ...
                          <div>
                            <p className="text-white fSize-2 fw-semibold">
                              EMI{" "}
                              <FontAwesomeIcon
